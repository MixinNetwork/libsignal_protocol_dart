...
const SessionStructure$json = const {
  ...
  '3': const [
    SessionStructure_Chain$json,
    SessionStructure_PendingKeyExchange$json,
    SessionStructure_PendingPreKey$json
  ],
};
...
const SessionStructure_Chain$json = const {
  ...
  '3': const [
    SessionStructure_Chain_ChainKey$json,
    SessionStructure_Chain_MessageKey$json
  ],
};
...
const SenderKeyStateStructure$json = const {
  ...
  '3': const [
    SenderKeyStateStructure_SenderChainKey$json,
    SenderKeyStateStructure_SenderMessageKey$json,
    SenderKeyStateStructure_SenderSigningKey$json
  ],
};
